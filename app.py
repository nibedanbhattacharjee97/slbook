...
st.text("The Slot Booking Platform is currently under development,so dont Book Slot For Now,If You Have Any Query Please Contact To Pritam Basu & Kousik Dey.")
